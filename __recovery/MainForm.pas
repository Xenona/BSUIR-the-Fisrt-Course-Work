...
function CopyAlbumFile2(const SrcFilename, DestDir: string): Boolean;
var
  DestFilename: string;
begin
  DestFilename := IncludeTrailingPathDelimiter(DestDir) + ExtractFileName(SrcFilename);
...
begin
  ...
  if FileOpenFolder.Execute then
    ...
    CopyAlbumFile(ExePath + '\src\' + CmbBxAlbum.Text + '.pics', folderPath);
